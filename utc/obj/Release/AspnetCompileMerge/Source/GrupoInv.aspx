    ...
    <asp:Panel runat="server" BackColor="WhiteSmoke" ID="pnlVerMienbros" Visible="false">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <div class="table table-responsive text-center" style="background-color: #F5F5F5;">
                    <br />
                    <asp:GridView runat="server" ID="gvwMiembros" CssClass="cabeza table table-bordered table-hover table-responsive text-center" DataKeyNames="strId_gru" ForeColor="#333333" GridLines="Horizontal" HorizontalAlign="Center" AutoGenerateColumns="false" ToolTip="registros...">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="ACCIONES" HeaderStyle-Font-Size="Small">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="btnEditarIntGruInv" CausesValidation="false" runat="server" CssClass="btn btn-warning btn-xs btn-circle" Text="<span class='glyphicon glyphicon-edit'></span>" OnClick="btnEditarIntGruInv_Click" ToolTip="Editar Registro." Style="color: white;" />
                                    <asp:LinkButton ID="btnBorrarIntGruInv" CausesValidation="false" runat="server" Text="<span class='glyphicon glyphicon-trash'></span>" CssClass="btn btn-danger btn-xs btn-circle" OnClick="btnBorrarIntGruInv_Click" Style="color: white;" OnClientClick="return confirm('Esta seguro que desea eliminar este registro, esta opción es irreversible?')" ToolTip="Eliminar registro." />
                                    <%--ELIMINANDO REGISTRO DE LA BDD --%>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
        ...
        args.IsValid = true;
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvFechaFinNuevoInt" runat="server" ControlToValidate="dtFechaFinNuevoInt" ErrorMessage="Ingrese la fecha de fin del nuevo integrante" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-md-4 text-center">
                                <br />
